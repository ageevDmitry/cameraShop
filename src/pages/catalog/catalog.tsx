    ...
    <div className="wrapper">
      ...
      <main>
        <div className="banner">
          <picture>
            <source type="image/webp" srcSet="img/content/banner-bg.webp, img/content/banner-bg@2x.webp 2x" /><img src="img/content/banner-bg.jpg" srcSet="img/content/banner-bg@2x.jpg 2x" alt="баннер" width={1280} height={280} />
          </picture>
                ...
                <div className="catalog__content">
                  ...
                  <div className="pagination">
                    <ul className="pagination__list">
                      ...
                      <li className="pagination__item"><a className="pagination__link" href="/">2</a>
                      </li>
